...
<form id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post">
	...
	<fieldset class="word">
		...
		<button name="Search" onclick="this.form.submit()" class="button btn btn-primary"><?php echo JText::_('COM_SEARCH_SEARCH');?></button>
		<input type="hidden" name="task" value="search" />
	</fieldset>

	<div class="text-success searchintro<?php echo $this->params->get('pageclass_sfx'); ?>">
