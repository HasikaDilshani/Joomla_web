		...
		<li>
...

			{
				...
				case 1:
					...
					echo '<a href="' . $link . '" target="_blank" rel="' . $params->get('follow', 'nofollow') . '">'.'<i class="fa fa-angle-right"> &nbsp; </i>' .
				...
				case 2:
					...
					echo "<a href=\"#\" onclick=\"window.open('" . $link . "', '', 'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=780,height=550'); return false\">" .
						...
						'<i class="fa fa-angle-right"> &nbsp; </i>'.htmlspecialchars($item->title, ENT_COMPAT, 'UTF-8') . '</a>';
